...
--
-- Host: aapwpbu9y229qi.cqxql2suz5ru.us-west-2.rds.amazonaws.com:3306
-- Generation Time: Apr 09, 2015 at 06:09 AM
...
CREATE TABLE IF NOT EXISTS `config` (
  ...
  `gas_price_87` int(11) NOT NULL DEFAULT '0',
  `gas_price_91` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
