...
Db=function(){function a(a){var d=null;if(0<arguments.length){for(var d=0,e=Array(arguments.length-0);d<e.length;)e[d]=arguments[d+0],++d;d=new I(e,0)}return b.call(this,d)}function b(a){return console.error.apply(console,Ob.a?Ob.a(a):Ob.call(null,a))}a.A=0;a.G=function(a){a=J(a);return b(a)};a.s=b;return a}();function al(a,b,c){var d=P(c,0);c=P(c,1);var e=new kk;ok.push(e);b&&e.Ha.add("complete",b,!1,void 0,void 0);e.Ha.add("ready",e.$d,!0,void 0,void 0);e.send(a,"POST",d,c)}
var bl=null,cl=null,dl=document.getElementById("base-url").getAttribute("value");function el(){return null!=J(bl)?yf(function(a){return a.setMap(null)},bl):null}function fl(){return yf(function(a){return a.setMap(cl)},bl)}
function gl(a){var b=[G(dl),G("orders-since-date")].join(""),c=function(){var b=ch(new Ib(null,1,[wh,a],null));return JSON.stringify(b)}(),d=ch(new Ib(null,1,["Content-Type","application/json"],null));al(b,function(a,b,c){return function(d){d=d.target;var l;l=d.I?ak(d.I.responseText):void 0;var n=l.orders;return bl=yf(function(){return function(a){return new google.maps.Circle({strokeColor:"#ff0000",strokeOpacity:1,strokeWeight:2,fillColor:"#ff0000",fillOpacity:1,map:cl,center:{lat:a.lat,lng:a.lng},
radius:10})}}(d,l,n,a,b,c),n)}}(b,c,d),wd([c,d],0));return null}
function hl(a){var b=ni(wd([new S(null,2,5,U,[Gh,new Ib(null,2,[Ih,"setCenterUI",Eh,"Click to recenter the map"],null)],null)],0)),c=ni(wd([new S(null,2,5,U,[Kh,new Ib(null,5,[Ch,"checkbox",zh,"orders",Ah,"orders",Ih,"orders-checkbox",Jh,!0],null)],null)],0)),d=ni(wd([new S(null,2,5,U,[Kh,new Ib(null,3,[Ch,"text",zh,"orders-date",Ah,"2015-05-01"],null)],null)],0)),e=new Pikaday(function(){return{field:d,format:"YYYY-MM-DD",onSelect:function(a,b,c){return function(){el();return gl(c.value)}}(b,c,d)}}()),
f=ni(wd([new S(null,6,5,U,[Gh,new Ib(null,1,[Ih,"setCenterText"],null),c,"Orders"," since date ",d],null)],0));a.appendChild(b);b.appendChild(f);c.addEventListener("click",function(a,b){return function(){return A(b.checked)?fl():el()}}(b,c,d,e,f))}
function il(){cl=new google.maps.Map(document.getElementById("map"),{center:{lat:34.0714522,lng:-118.40362},zoom:16});var a=ni(wd([new S(null,1,5,U,[Gh],null)],0));a.index=1;hl(a);a.index=1;cl.controls[google.maps.ControlPosition.LEFT_TOP].push(a);return gl("2015-05-01")}var jl=["dashboard_cljs","core","init_map"],kl=u;jl[0]in kl||!kl.execScript||kl.execScript("var "+jl[0]);for(var ll;jl.length&&(ll=jl.shift());)!jl.length&&ba(il)?kl[ll]=il:kl=kl[ll]?kl[ll]:kl[ll]={};