...
h.getResponseHeader=function(a){return this.I&&4==Mj(this)?this.I.getResponseHeader(a):void 0};h.getAllResponseHeaders=function(){return this.I&&4==Mj(this)?this.I.getAllResponseHeaders():""};function Fj(a,b){return b+" ["+a.Cc+" "+a.Wb+" "+a.getStatus()+"]"};var Z,Oj=new u(null,8,[qh,5E3,dh,[],jh,[],Lh,new u(null,2,[Ph,!0,ih,"#8E44AD"],null),yh,null,eh,moment().subtract(30,"days").format("YYYY-MM-DD"),kh,moment().format("YYYY-MM-DD"),zh,new u(null,6,[Ah,new u(null,2,[ih,"#ff0000",Ph,!0],null),rh,new u(null,2,[ih,"#808080",Ph,!0],null),Sh,new u(null,2,[ih,"#ffdd00",Ph,!0],null),Qh,new u(null,2,[ih,"#0000ff",Ph,!0],null),Hh,new u(null,2,[ih,"#00ff00",Ph,!0],null),wh,new u(null,2,[ih,"#000000",Ph,!0],null)],null)],null);Z=U.a?U.a(Oj):U.call(null,Oj);
function Pj(a,b){var c=b.target;return y(Nj(c))?(c=c.I?Xi(c.I.responseText):void 0,a.a?a.a(c):a.call(null,c)):console.log([E("xhrio-wrapper error:"),E(c.lastError_)].join(""))}function Qj(a,b){return J(hf(function(a){return Zc.b(b,a.id)},a))}function Rj(a,b){var c=a[""+E("timestamp_created")];a[""+E("timestamp_created")]=b.a?b.a(c):b.call(null,c)}function Sj(a,b){Ua(b,function(){return function(b,d){return a[""+E(d)]=b}}(b))}function Tj(a){return moment.unix(a).format("MM/DD hh:mm A")}var Uj=document.getElementById("base-url").getAttribute("value");
function Vj(a,b,c,d){b=new google.maps.Circle({strokeColor:c,strokeOpacity:1,strokeWeight:1,fillColor:c,fillOpacity:1,map:b,center:{lat:a.lat,lng:a.lng},radius:200});b.addListener("click",d);a.circle=b}function Wj(a,b){var c=Math.pow(2,21-a);return b.circle.setRadius(21<=a?1:10>=a?200:10<a&&21>a?.3046942494*c:null)}
function Xj(a,b){var c=b.circle.center,d=c.lat(),c=c.lng(),e=yh.a(M.a?M.a(a):M.call(null,a)).getZoom(),f=b.label;f.set("position",new google.maps.LatLng(d+-1*Math.pow(10,-1*e/4.2),c));return f.draw()}ea("dashboard_cljs.core.get_map_info",function(){return console.log([E("Map-Zoom:"),E(yh.a(M.a?M.a(Z):M.call(null,Z)).getZoom()),E(" "),E("Font-size:"),E(J(jh.a(M.a?M.a(Z):M.call(null,Z))).label.fontSize),E(" "),E("label-lat:"),E(J(jh.a(M.a?M.a(Z):M.call(null,Z))).label.position.lat())].join(""))});
function Yj(a,b,c){b=new MapLabel({map:b,position:new google.maps.LatLng(a.lat+-1*Math.pow(10,-1*b.getZoom()/4.2),a.lng),text:c,fontSize:12,align:"center"});a.label=b}function Zj(a,b){a["info-window"]=new google.maps.InfoWindow({position:{lat:a.lat,lng:a.lng},content:b.outerHTML})}function ak(a,b){return b["info-window"].open(yh.a(M.a?M.a(a):M.call(null,a)))}
function bk(a){return qi(H([new Q(null,2,5,R,[hh,se.b(function(a){var c;null!=bc(a)?(c=ac(a),a=new Q(null,3,5,R,[xh,new u(null,1,[Dh,"info-window-value"],null),bc(a)],null),c=qi(H([new Q(null,3,5,R,[ph,new Q(null,3,5,R,[nh,new u(null,1,[Dh,"info-window-td"],null),c],null),new Q(null,2,5,R,[nh,a],null)],null)],0))):c=null;return c},a)],null)],0))}
function ck(a){var b=a.address_city,c=a.address_state,d=a.courier_name,e=a.customer_name,f=a.customer_phone_number,c=[E(a.address_street),E("\x3c/br\x3e"),E(null!=I(b)&&null!=I(c)?[E(a.address_city),E(","),E(a.address_state),E(" ")].join(""):null),E(a.address_zip)].join(""),g=document,b=g.createElement("DIV");cb?(b.innerHTML="\x3cbr\x3e"+c,b.removeChild(b.firstChild)):b.innerHTML=c;if(1==b.childNodes.length)b=b.removeChild(b.firstChild);else{for(c=g.createDocumentFragment();b.firstChild;)c.appendChild(b.firstChild);
b=c}var c=a.license_plate,g=a.gallons,k=a.gas_type,l;l=a.total_price;l=[E("$"),E((l/100).toFixed(2))].join("");a=new u(null,10,["Courier",d,"Customer",e,"Phone",f,"Address",b,"Plate #",c,"Gallons",g,"Octane",k,"Total Price",l,"Placed",Tj(a.target_time_start),"Deadline",Tj(a.target_time_end)],null);return bk(a)}function dk(a){return bk(new u(null,3,["Name",a.name,"Phone",a.phone_number,"Last Seen",Tj(a.last_ping)],null))}
function ek(a,b){var c=Date.parse(eh.a(M.a?M.a(a):M.call(null,a))),d=b.timestamp_created,e=Date.parse(kh.a(M.a?M.a(a):M.call(null,a)))+864E5,f=b.status,f=lf(M.a?M.a(a):M.call(null,a),new Q(null,3,5,R,[zh,Ce.a(f),Ph],null));return(c=c<=d&&d<=e)?f:c}function fk(a,b,c,d){return kf(function(b){if(y(d.a?d.a(b):d.call(null,b))){var f=yh.a(M.a?M.a(a):M.call(null,a));b=null!=b[c]?b[c].setMap(f):null}else b=null!=b[c]?b[c].setMap(null):null;return b},b)}
function gk(a,b){var c=b.active,d=b.on_duty,e=b.connected,f=lf(M.a?M.a(a):M.call(null,a),new Q(null,2,5,R,[Lh,Ph],null));return y(e)?y(c)?y(d)?f:d:c:e}function hk(a){function b(b){return fk(a,jh.a(M.a?M.a(a):M.call(null,a)),b,Xe(gk,a))}b("circle");return b("label")}function ik(a){var b=a.circle;y(a.busy)?b.setOptions(Og(new u(null,1,[Ih,new u(null,1,[Fh,"#ff0000"],null)],null))):b.setOptions(Og(new u(null,1,[Ih,new u(null,1,[Fh,"#00ff00"],null)],null)))}
function jk(a,b,c,d){d=P(d,0);a=[E(Uj),E(a)].join("");var e=Og(new u(null,1,["Content-Type","application/json"],null)),e=H([b,e,d],0);b=P(e,0);d=P(e,1);var e=P(e,2),f=new yj;Ej.push(f);c&&f.Da.add("complete",c,!1,void 0,void 0);f.Da.add("ready",f.Mc,!0,void 0,void 0);e&&(f.ob=Math.max(0,e));f.send(a,"POST",b,d);return f}
function kk(a,b){var c=Qj(jh.a(M.a?M.a(a):M.call(null,a)),b.id);if(null==c)return Vj(b,yh.a(M.a?M.a(a):M.call(null,a)),lf(M.a?M.a(a):M.call(null,a),new Q(null,2,5,R,[Lh,ih],null)),function(){return function(){return ak(a,b)}}(c)),Yj(b,yh.a(M.a?M.a(a):M.call(null,a)),b.name),ik(b),Zj(b,dk(b)),jh.a(M.a?M.a(a):M.call(null,a)).push(b);var d=c.circle,e=c["info-window"],f=new google.maps.LatLng(b.lat,b.lng);Sj(c,b);d.setCenter(f);Xj(a,c);ik(c);e.setContent(dk(c).outerHTML);return e.setPosition(f)}
function lk(a){for(var b=[],c=arguments.length,d=0;;)if(d<c)b.push(arguments[d]),d+=1;else break;mk(arguments[0],1<b.length?new jd(b.slice(1),0):null)}function mk(a,b){var c=P(b,0);jk("couriers",Se,Xe(Pj,function(){return function(b){b=b.couriers;return null!=b?(kf(Xe(kk,a),b),hk(a)):null}}(b,c)),H([c],0))}function nk(a){for(var b=[],c=arguments.length,d=0;;)if(d<c)b.push(arguments[d]),d+=1;else break;ok(arguments[0],arguments[1],2<b.length?new jd(b.slice(2),0):null)}
function ok(a,b,c){c=P(c,0);a=Og(new u(null,1,[fh,a],null));a=JSON.stringify(a);return jk("orders-since-date",a,b,H([c],0))}
function pk(a,b){var c=Qj(dh.a(M.a?M.a(a):M.call(null,a)),b.id);if(null==c)return Vj(b,yh.a(M.a?M.a(a):M.call(null,a)),lf(M.a?M.a(a):M.call(null,a),new Q(null,3,5,R,[zh,Ce.a(b.status),ih],null)),function(){return function(){return ak(a,b)}}(c)),Rj(b,function(){return function(a){return Date.parse(a)}}(c)),Zj(b,ck(b)),dh.a(M.a?M.a(a):M.call(null,a)).push(b);Sj(c,b);Rj(c,function(){return function(a){return Date.parse(a)}}(c));c["info-window"].setContent(ck(c).outerHTML);var d=lf(M.a?M.a(a):M.call(null,
a),new Q(null,3,5,R,[zh,Ce.a(c.status),ih],null));return c.circle.setOptions(Og(new u(null,1,[Ih,new u(null,2,[Oh,d,Fh,d],null)],null)))}function qk(a,b){nk(b,Xe(Pj,function(b){b=b.orders;return null!=b?(kf(Xe(pk,a),b),fk(a,dh.a(M.a?M.a(a):M.call(null,a)),"circle",Xe(ek,a))):null}))}
function rk(){return ok(moment().format("YYYY-MM-DD"),Xe(Pj,function(a){a=a.orders;return null!=a?(kf(Xe(pk,Z),a),fk(Z,dh.a(M.a?M.a(Z):M.call(null,Z)),"circle",Xe(ek,Z))):null}),H([qh.a(M.a?M.a(Z):M.call(null,Z))],0))}function sk(a){for(var b=[],c=arguments.length,d=0;;)if(d<c)b.push(arguments[d]),d+=1;else break;return tk(arguments[0],1<b.length?new jd(b.slice(1),0):null)}
function tk(a,b){var c=P(b,0);return qi(H([new Q(null,2,5,R,[xh,new u(null,1,[vh,[E("height: 10px;"),E(" width: 10px;"),E(" display: inline-block;"),E(" float: right;"),E(" border-radius: 10px;"),E(" margin-top: 7px;"),E(" margin-left: 5px;"),E(" background-color: "),E(a),E("; "),E(null!=c?[E(" border: 1px solid "),E(c),E(";")].join(""):null)].join("")],null)],null)],0))}
function uk(a){var b=qi(H([new Q(null,2,5,R,[Jh,new u(null,5,[th,"checkbox",mh,"orders",oh,"orders",Dh,"orders-checkbox",Eh,!0],null)],null)],0)),c=qi(H([new Q(null,5,5,R,[xh,new u(null,1,[Dh,"setCenterText"],null),b,a,sk(lf(M.a?M.a(Z):M.call(null,Z),new Q(null,3,5,R,[zh,Ce.a(a),ih],null)))],null)],0));b.addEventListener("click",function(b){return function(){y(b.checked)?ef.m(Z,mf,new Q(null,3,5,R,[zh,Ce.a(a),Ph],null),!0):ef.m(Z,mf,new Q(null,3,5,R,[zh,Ce.a(a),Ph],null),!1);return fk(Z,dh.a(M.a?
M.a(Z):M.call(null,Z)),"circle",Xe(ek,Z))}}(b,c));return c}function vk(){return qi(H([new Q(null,2,5,R,[xh,new Q(null,3,5,R,[xh,new u(null,2,[Dh,"setCenterUI",uh,"Select order status"],null),se.b(function(a){return uk(a)},Xc("unassigned","accepted","enroute","servicing","complete","cancelled"))],null)],null)],0))}
function wk(){function a(a){return qi(H([new Q(null,2,5,R,[Jh,new u(null,4,[th,"text",mh,"orders-date",Dh,"date-picker",oh,a],null)],null)],0))}var b=function(){return function(a,b){return new Pikaday({field:a,format:"YYYY-MM-DD",onSelect:b})}}(a),c=a(eh.a(M.a?M.a(Z):M.call(null,Z))),d=b(c,function(a,b,c){return function(){ef.m(Z,Td,eh,c.value);return fk(Z,dh.a(M.a?M.a(Z):M.call(null,Z)),"circle",Xe(ek,Z))}}(a,b,c)),e=a(kh.a(M.a?M.a(Z):M.call(null,Z)));b(e,function(a,b,c,d,e){return function(){ef.m(Z,
Td,kh,e.value);return fk(Z,dh.a(M.a?M.a(Z):M.call(null,Z)),"circle",Xe(ek,Z))}}(a,b,c,d,e));return qi(H([new Q(null,2,5,R,[xh,new Q(null,3,5,R,[xh,new u(null,2,[Dh,"setCenterUI",uh,"Click to change dates"],null),new Q(null,9,5,R,[xh,new u(null,1,[Dh,"setCenterText"],null),"Orders",new Q(null,1,5,R,[Gh],null),"From: ",c,new Q(null,1,5,R,[Gh],null),"To:   ",e],null)],null)],null)],0))}
function xk(){var a=qi(H([new Q(null,2,5,R,[Jh,new u(null,5,[th,"checkbox",mh,"couriers",oh,"couriers",Dh,"couriers-checkbox",Eh,!0],null)],null)],0)),b=qi(H([new Q(null,10,5,R,[xh,new u(null,1,[Dh,"setCenterText"],null),a,"Couriers",new Q(null,1,5,R,[Gh],null),"Busy",tk(lf(M.a?M.a(Z):M.call(null,Z),new Q(null,2,5,R,[Lh,ih],null)),H(["#ff0000"],0)),new Q(null,1,5,R,[Gh],null),"Not Busy",tk(lf(M.a?M.a(Z):M.call(null,Z),new Q(null,2,5,R,[Lh,ih],null)),H(["#00ff00"],0))],null)],0));a.addEventListener("click",
function(a){return function(){y(a.checked)?ef.m(Z,mf,new Q(null,2,5,R,[Lh,Ph],null),!0):ef.m(Z,mf,new Q(null,2,5,R,[Lh,Ph],null),!1);return fk(Z,jh.a(M.a?M.a(Z):M.call(null,Z)),"circle",Xe(gk,Z))}}(a,b));return qi(H([new Q(null,2,5,R,[xh,new Q(null,3,5,R,[xh,new u(null,2,[Dh,"setCenterUI",uh,"Select couriers"],null),b],null)],null)],0))}function yk(a,b){a.controls[google.maps.ControlPosition.LEFT_TOP].push(b)}
var zk=function zk(b,c){return setTimeout(function(){b.w?b.w():b.call(null);return zk(b,c)},c)};
ea("dashboard_cljs.core.init_map_orders",function(){ef.m(Z,Td,yh,new google.maps.Map(document.getElementById("map"),{center:{lat:34.0714522,lng:-118.40362},zoom:12}));yh.a(M.a?M.a(Z):M.call(null,Z)).addListener("zoom_changed",function(){return kf(Xe(Wj,yh.a(M.a?M.a(Z):M.call(null,Z)).getZoom()),dh.a(M.a?M.a(Z):M.call(null,Z)))});yk(yh.a(M.a?M.a(Z):M.call(null,Z)),qi(H([new Q(null,3,5,R,[xh,wk(),vk()],null)],0)));qk(Z,"");return zk(function(){return rk()},6E5)});
ea("dashboard_cljs.core.init_map_couriers",function(){ef.m(Z,Td,yh,new google.maps.Map(document.getElementById("map"),{center:{lat:34.0714522,lng:-118.40362},zoom:12}));yh.a(M.a?M.a(Z):M.call(null,Z)).addListener("zoom_changed",function(){kf(Xe(Wj,yh.a(M.a?M.a(Z):M.call(null,Z)).getZoom()),dh.a(M.a?M.a(Z):M.call(null,Z)));kf(Xe(Wj,yh.a(M.a?M.a(Z):M.call(null,Z)).getZoom()),jh.a(M.a?M.a(Z):M.call(null,Z)));return kf(Xe(Xj,Z),jh.a(M.a?M.a(Z):M.call(null,Z)))});yk(yh.a(M.a?M.a(Z):M.call(null,Z)),qi(H([new Q(null,
3,5,R,[xh,vk(),qi(H([new Q(null,2,5,R,[xh,xk()],null)],0))],null)],0)));qk(Z,moment().format("YYYY-MM-DD"));lk(Z);return zk(function(){mk(Z,H([qh.a(M.a?M.a(Z):M.call(null,Z))],0));return rk()},qh.a(M.a?M.a(Z):M.call(null,Z)))});