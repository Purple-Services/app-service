...
(ns purple.fb.client
  ...
  (:use [purple.fb.helper :only [wrap-exceptions facebook-base-url facebook-fql-base-url]]
        [purple.fb.auth :only [wrap-facebook-access-token]]
        [purple.fb.error-handling :only [wrap-facebook-exceptions]]
...
(defn gett ;; added t to differentiate conflicts
