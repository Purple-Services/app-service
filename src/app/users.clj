...
;; (let [reset-key "KCTc0SJ6729KmImOlO14hU"]
;;   (send-template-email
;;    "chris@purpleapp.com"
;;    "Welcome to Purple"
;;    "test"
;;    :template-id "e93dbfd4-ccca-4577-8de9-025fc67eff14"
;;    :substitutions {:%RESETLINK% (str "Please click the link below to set your password:"
;;                                      "<br />https://purpledelivery.com/user/reset-password/" reset-key)}))


;; (run! #(send-template-email
;;         (:email %)
;;         "Welcome to Purple"
;;         "test"
;;         :template-id "e93dbfd4-ccca-4577-8de9-025fc67eff14"
;;         :substitutions {:%RESETLINK% (str "Please click the link below to set your password:"
;;                                           "<br />https://purpledelivery.com/user/reset-password/" (:reset_key %))})
;;       (remove #(= "matt@mauzy.com" (:email %))
;;               (!select (common.db/conn) "users" ["*"] {:account_manager_id "BmFyfnvXpDaVcGvOrsng"})))
...
;;           "honda0732@gmail.com"
;;           "jnchsken87ds"
;;           :account-manager-id "BmFyfnvXpDaVcGvOrsng"
...
;;              "xxJkEnQYqeAmKRY7uifT"
;;              {:year "2010"
;;               :make "Chevy"
;;               :model "Express"
;;               :color "Unknown"
;;               :gas_type "87"
;;               :license_plate "8Y96520"
;;               :only_top_tier false})

;; (let [db-conn (common.db/conn)]
;;   (run! #(add-vehicle db-conn
;;                       (:id %)
;;                       {:year (:year %)
;;                        :make (:make %)
;;                        :model (:model %)
...
;;           :id "kjiFGCD5dL0PukZsaphL"}
;;          {:year "2016"
;;           :make "Maserati"
;;           :model "Ghibli"
;;           :license_plate "7PTM302"
;;           :email "matt@mauzy.com"
;;           :id "RnHZXXiDB2OFEVslK7GO"}
;;          {:year "2012"
;;           :make "Nissan"
;;           :model "NV"
;;           :license_plate "29113D1"
;;           :email "ehlyrenales@gmail.com"
;;           :id "etckc5d3HagovQDriwHk"}
;;          {:year "2011"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "34557D1"
;;           :email "dillon@mauzy.com"
;;           :id "zhlCYrSLysCkXRxMGAAm"}
;;          {:year "2012"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "13719F1"
;;           :email "Bush.frederick@yahoo.com"
;;           :id "y4yQ8sFvvEtZWSKVHY7E"}
;;          {:year "2012"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "66690H1"
;;           :email "travis@mauzy.com"
;;           :id "Sevet2j3bqap5S3BqX0X"}
;;          {:year "2012"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "66970H1"
;;           :email "gary@mauzy.com"
;;           :id "hd3OeqiPYGDMbfM6IryK"}
;;          {:year "2012"
;;           :make "Chevy"
;;           :model "Cruze"
;;           :license_plate "6XYE009"
;;           :email "penny@mauzy.com"
;;           :id "yAIZ5LKgIDpohf38gz39"}
;;          {:year "2012"
;;           :make "Nissan"
;;           :model "NV"
;;           :license_plate "14049H1"
;;           :email "eccutter@cox.net"
;;           :id "HqBrqniUX2LdOduzgNzd"}
;;          {:year "2013"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "44986K1"
;;           :email "muscutt86@gmail.com"
;;           :id "wvlo9PJPP3hdEOyhTiBi"}
;;          {:year "2013"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "88562N1"
;;           :email "brianpannek@gmail.com"
;;           :id "8vzZHeYJyXoLDwCgxbWC"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "54846R1"
;;           :email "Scottdtax@gmail.com"
;;           :id "LpM5c5NBjTqYC8KEWHWf"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "55041R1"
;;           :email "mauzyryan911@gmail.com"
;;           :id "2HXAz5Lsa7w9GpjuYEp0"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "56677R1"
;;           :email "Bnmrobeson@gmail.com"
;;           :id "VUmh2QY3wSpkResDCjud"}
;;          {:year "2015"
;;           :make "Toyota"
;;           :model "Prius"
;;           :license_plate "7JBT500"
;;           :email "jtentor@mauzy.com"
;;           :id "Oj48NBe4L2BBGLjttQ8g"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "Colorado"
;;           :license_plate "77863T1"
;;           :email "leonard@mauzy.com"
;;           :id "lqBBkKdbR6LQs6KOZ9q9"}
;;          {:year "2015"
;;           :make "Toyota"
;;           :model "Prius"
;;           :license_plate "7KFG321"
;;           :email "paul@mauzy.com"
;;           :id "VTOL6mwWlGyUTuf2ZnYl"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "58758V1"
;;           :email "jplynn31668@hotmail.com"
;;           :id "m9p7rCX1ojulS1exsLs1"}
;;          {:year "2015"
;;           :make "Toyota"
;;           :model "Prius"
;;           :license_plate "7LBZ550"
;;           :email "cody@mauzy.com"
;;           :id "0KGyhNT9u4X98MeHGdMb"}
;;          {:year "2015"
;;           :make "Toyota"
;;           :model "Prius"
;;           :license_plate "7LBZ549"
;;           :email "jason@mauzy.com"
;;           :id "ROnLGrcw3tCFflh9Iy7z"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "Silverado"
;;           :license_plate "58027V1"
;;           :email "jrross1989@gmail.com"
;;           :id "zphwOYElcYwAe0kmwFqy"}
;;          {:year "2015"
;;           :make "Toyota"
;;           :model "Prius"
;;           :license_plate "7LKX180"
;;           :email "joel@mauzy.com"
;;           :id "AuAQC6PvgcJ7dQXONbvL"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "2500HD"
;;           :license_plate "82515W1"
;;           :email "devosevich@gmail.com"
;;           :id "zYGKZGeAFlbfYcA4Y7Z5"}
;;          {:year "2015"
;;           :make "Toyota"
;;           :model "Prius"
;;           :license_plate "7MWC839"
;;           :email "Mikel@628hotmail.com"
;;           :id "vZafg4Q78aHEPdG8npI8"}
;;          {:year "2015"
;;           :make "Toyota"
;;           :model "Prius"
;;           :license_plate "7NKY374"
;;           :email "steven@mauzy.com"
;;           :id "UyOJWB50tyA8gpMXX4fh"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "2500HD"
;;           :license_plate "54696X1"
;;           :email "Joraha11@hotmail.com"
;;           :id "rqaCfM6Qk9b3Hp2xeaFc"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "2500HD"
;;           :license_plate "83851X1"
;;           :email "clintcox57@gmail.com"
;;           :id "XiTHILFZ35yJ908jrm5G"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "2500HD"
;;           :license_plate "83049X1"
;;           :email "scherman82@yahoo.com"
;;           :id "qNa4xuj4Y8ItXwpCuVV8"}
;;          {:year "2015"
;;           :make "Chevy"
;;           :model "2500HD"
;;           :license_plate "83850X1"
;;           :email "mike@mauzy.com"
;;           :id "abdKtxY9Hx3xoaPI09po"}
;;          {:year "2016"
;;           :make "Chevy"
;;           :model "COLORADO"
;;           :license_plate "91919Y1"
;;           :email "jim@mauzy.com"
;;           :id "kJ1neAaySpuF850ogyf6"}
;;          {:year "2016"
;;           :make "Chevy"
;;           :model "2500HD"
;;           :license_plate "56867Z1"
;;           :email "RonnyP760@gmail.com"
;;           :id "3bU7661im5I9WN33goQ4"}
;;          {:year "2016"
;;           :make "Nissan"
;;           :model "NV"
;;           :license_plate "73259A2"
;;           :email "socal4523@gmail.com"
;;           :id "8WTbmqoKxUOvmZB5jFrg"}
;;          {:year "2016"
;;           :make "Nissan"
;;           :model "NV"
;;           :license_plate "73213A2"
;;           :email "6334138@gmail.com"
;;           :id "keQyNeL9phs7y6hHhE4M"}
;;          {:year "2016"
;;           :make "Chevy"
;;           :model "HD2500HD"
;;           :license_plate "08221B2"
;;           :email "Cholsclaw98@gmail.com"
;;           :id "PTAmAwYLByDeIRA4YQg5"}
;;          ]))
